...
month_wuxing_state = {  
    # 1月2月属木  
    1: {'木': '旺', '水': '相', '火': '休', '金': '囚', '土': '死'},  
    2: {'木': '旺', '水': '相', '火': '休', '金': '囚', '土': '死'},  
    # 3月属土  
    3: {'土': '旺', '火': '相', '金': '休', '木': '囚', '水': '死'},  
    # 4月5月属火  
    4: {'火': '旺', '木': '相', '土': '休', '水': '囚', '金': '死'},  
    5: {'火': '旺', '木': '相', '土': '休', '水': '囚', '金': '死'},  
    # 6月属土  
    6: {'土': '旺', '火': '相', '金': '休', '木': '囚', '水': '死'},  
    # 7月8月属金  
    7: {'金': '旺', '土': '相', '水': '休', '火': '囚', '木': '死'},  
    8: {'金': '旺', '土': '相', '水': '休', '火': '囚', '木': '死'},  
    # 9月属土  
    9: {'土': '旺', '火': '相', '金': '休', '木': '囚', '水': '死'},  
    # 10月11月属水  
    10: {'水': '旺', '金': '相', '木': '休', '土': '囚', '火': '死'},  
    11: {'水': '旺', '金': '相', '木': '休', '土': '囚', '火': '死'},  
    # 12月属土  
    12: {'土': '旺', '火': '相', '金': '休', '木': '囚', '水': '死'}  
}
